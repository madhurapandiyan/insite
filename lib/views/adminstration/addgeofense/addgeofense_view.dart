    ...
    return ViewModelBuilder<AddgeofenseViewModel>.reactive(
      builder:
        ...
        return InsiteScaffold(
          viewModel: viewModel,
          body: viewModel.isLoading?Center(child: InsiteProgressBar(),):
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (viewModel.initialValue ==
                            ...
                            viewModel.initialValue == viewModel.dropDownlist[6])
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              InsiteText(
                                              ...
                                              child: ListView.builder(
                                                ...
                                                itemBuilder:
                                                  ...
                                                  return ListTile(
                                                    onTap: () {
                                                      setState(() {
                                                        viewModel.initialName =
                                                            data[i].name;
                                                        viewModel.materialUID =
                                                            data[i].materialUid;
                                                      });
                                                    },
                                                    title: InsiteText(
                        ...
                        InkWell(
                            onTap: viewModel.isNoendDate ? null : endDatePicker,
                            borderRadius: BorderRadius.circular(20),
                            child: Container(
                              width: double.infinity,
                              height: mediaquerry.size.height * 0.05,
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              InsiteButton(
                                onTap: () {
                                  Logger().e(viewModel.titleController.text);
                                  try {
