          ...
          title: Table(
            ...
            children: [
                  ...
                  children: [
                    ...
                    Container(
                        decoration: BoxDecoration(
                            ...
                            border:
                                Border.all(width: 2.5, color: containercolor),
              ...
              TableRow(children: [
                InsiteRichText(
                  title: "Asset SN :",
                  content: assetSetting!.assetSettings!.assetSerialNumber != null
                      ? assetSetting!.assetSettings!.assetSerialNumber
                      : "-",
                ),
                InsiteTableRowItem(
                  title: "Device ID :",
                  content: assetSetting!.assetSettings!.deviceSerialNumber != null
