              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(20), color: tuna),
                                      ...
                                      child: ListView.builder(
                                        ...
                                        itemBuilder:
                                          ...
                                          return DeviceIdListWidget(
                                              onSelected: () {
                                                viewModel.onSelectedDeviceId(i);
                                ...
                                children: [
                                  InsiteButton(
                                    onTap: () {
                                      if (viewModel.isBackPressed) {
                                        ...
                                        viewModel.showingOldDeviceIdPreview();
                                      }
                                    },
                                    bgColor: tuna,
                                    title: "Back",
                                  ...
                                  InsiteButton(
                                    onTap: !viewModel.showNewPreview
                                        ?viewModel.initialvalue==viewModel.dropDownValues[0] || viewModel.replaceDeviceIdController.text.isEmpty?null:  () {
                                            setState(() {
                                              viewModel.showNewPreview =
                                                  !viewModel.showNewPreview;
