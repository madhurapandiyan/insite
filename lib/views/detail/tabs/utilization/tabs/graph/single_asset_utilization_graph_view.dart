                ...
                itemBuilder: (BuildContext context, int index) {
                  if (selectedGraph ==
                    ...
                    return PercentageWidget(
                      ...
                      SingleAssetUtilizationGraphType.RUNTIMEPERFORMANCEPERCENT)
                    return PercentageWidget(
                      color: bermudaGrey,
                      label:
                          '${DateFormat('dd/MM/yy').format(viewModel.singleAssetUtilization.daily[index].startDate)}',
                      percentage: viewModel.singleAssetUtilization.daily[index]
                                  .data.targetRuntimePerformance ==
                              null
                          ? null
                          : viewModel.singleAssetUtilization.daily[index].data
                    ...
                    return IdleWorkingGraphWidget(
                      idleLength: rangeChoice == 1
                          ...
                          : rangeChoice == 2
                              ? getValues(
                                  viewModel.singleAssetUtilization.weekly[index]
                                      .data.idleHours,
                                  1500,
                                  false)
                              : getValues(
