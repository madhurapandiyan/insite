...
SubscriptionDashboardDetailResult _$SubscriptionDashboardDetailResultFromJson(
    ...
    SubscriptionDashboardDetailResult(
      ...
      deviceTransfer: (json['deviceTransfer'] as List<dynamic>?)
          ...
          .toList(),
      deviceTransferCount: json['deviceTransferCount'] == null
          ? null
          : DeviceTransferCount.fromJson(
              json['deviceTransferCount'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$SubscriptionDashboardDetailResultToJson(
        SubscriptionDashboardDetailResult instance) =>
    <String, dynamic>{
      'deviceTransferCount': instance.deviceTransferCount,
...
DeviceTransferCount _$DeviceTransferCountFromJson(Map<String, dynamic> json) =>
    DeviceTransferCount(
      count: json['count'] as String?,
    );

Map<String, dynamic> _$DeviceTransferCountToJson(
        DeviceTransferCount instance) =>
    <String, dynamic>{
      'count': instance.count,
    };
