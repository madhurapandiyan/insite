...
part of 'maintenance_asset.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

MaintenanceAsset _$MaintenanceAssetFromJson(Map<String, dynamic> json) =>
    MaintenanceAsset(
      assetCentricData: (json['assetCentricData'] as List<dynamic>?)
          ?.map((e) => AssetCentricData.fromJson(e as Map<String, dynamic>))
          .toList(),
...
Map<String, dynamic> _$MaintenanceAssetToJson(MaintenanceAsset instance) =>
    <String, dynamic>{
      'assetCentricData': instance.assetCentricData,
...
AssetCentricData _$AssetCentricDataFromJson(Map<String, dynamic> json) =>
    AssetCentricData(
      overDueCount: json['overDueCount'] as num?,
      upcomingCount: json['upcomingCount'] as num?,
