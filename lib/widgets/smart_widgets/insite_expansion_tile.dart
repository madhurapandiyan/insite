...
class InsiteExpansionTile extends StatefulWidget {
  /// Creates a single-line [ListTile] with a trailing button that expands or collapses
  /// the tile to reveal or hide the [children]. The [initiallyExpanded] property must
  /// be non-null.
  const InsiteExpansionTile({
    Key? key,
    this.leading,
    required this.title,
    this.subtitle,
...
//  final Widget trailing;
  ...
  @override
  _InsiteExpansionTileState createState() => _InsiteExpansionTileState();
}

class _InsiteExpansionTileState extends State<InsiteExpansionTile>
